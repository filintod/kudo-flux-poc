...
func (r *KudoFluxReconciler) requestsForRevisionChangeOf(indexKey string) func(obj client.Object) []reconcile.Request {
	return func(obj client.Object) []reconcile.Request {
		...
		for _, d := range list.Items {
			...
			// we should not make a request for this Kudo Instance
			if repo.GetArtifact().Revision == d.Status.LastAttemptedRevision {
				continue
			}
			reqs = append(reqs, reconcile.Request{NamespacedName: ObjectKey(&d)})
		}
		return reqs
	}
}

func (r *KudoFluxReconciler) indexBy(kind string) func(o client.Object) []string {
	return func(o client.Object) []string {
		k, ok := o.(*kudov1.KudoFlux)
		if !ok {
