...
type CrossNamespaceObjectReference struct {
	...
	// +kubebuilder:validation:Enum=KudoRepository;GitRepository;Bucket
	// +required
...
// ParametersReference contains a reference to a resource containing Helm values,
...
type ParametersReference struct {
	...
	// Optional marks this ParametersReference as optional. When set, a not found error
...
func (in ParametersReference) GetValuesKey() string {
	if in.ValuesKey == "" {
		return "values.yaml"
	}
	return in.ValuesKey
